        ...
        <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
            <ul class="pagination">
                ...
                <li class="paginate_button page-item previous">
                    <a href="{{ $paginator->previousPageUrl() }}" aria-controls="DataTables_Table_0" role="prev" data-dt-idx="previous" tabindex="0" class="page-link">{{ __('admin.pagination.previous') }}</a>
                </li>
                @endif
                ...
                <li class="paginate_button  page-item next">
                    <a class="page-link" href="{{ $paginator->nextPageUrl() }}" rel="next">{{ __('admin.pagination.next') }}</a>
                </li>
                @else
